            ...
            <div class="col-lg-9 main-content">
                ...
                <div class="row">
                    ...
                    @php
                        ...
                        $productVariation = $product->lowestPriceVariation;
                    @endphp
                    ...
                    @empty
                        <div class="col-12">
                            <h4 class="text-center">No product in this category</h4>
                        </div>
                    @endforelse
                    ...
                    {{-- <div class="widget">
                        ...
                        <div class="collapse show" id="widget-body-2">
                            <div class="widget-body">
                                ...
                                @endphp
                                    <li>
                                        <a href="#cat-{{ $category->id }}" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="widget-category-1" class="{{ $category->id == $categoryId ? 'text-primary' : ''}}">
                                            {{ $category->category_name }}<span class="products-count">({{count($category->products)}})</span>
                    ...
                    <div class="widget widget-featured">
                        ...
                        <div class="widget-body">
                            <div class="owl-carousel widget-featured-products">
                                ...
                                @foreach ($featureds->chunk(3) as $chunk)
                                    
                                
                                <div class="featured-col">
                                    @foreach ($chunk as $featured)
                                    @php
                                        $productVariation = App\Models\ProductVariation::where('product_id', $featured->id)->orderBy('discount_price')->first();
                                    @endphp
                                    <div class="product-default left-details product-widget">
                                        <figure>
                                            <a href="product.html">
                                                <img src="{{ asset($featured->product_thumbnail) }}" width="75" height="75" alt="product" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                            <h3 class="product-title"> <a href="product.html">{{ $featured->product_name }}</a> </h3>
                                            <div class="ratings-container">
                                                <div class="product-ratings">
